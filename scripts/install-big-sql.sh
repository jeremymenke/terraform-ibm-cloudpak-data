...
echo '*** executing **** kubectl create -f big-sql-sub.yaml'
result=$(kubectl create -f big-sql-sub.yaml)
echo $result
...
echo '*** executing **** kubectl create -f big-sql-cr.yaml'
result=$(kubectl create -f big-sql-cr.yaml)
echo $result
