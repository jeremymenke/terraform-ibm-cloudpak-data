...
echo '*** executing **** kubectl create -f ds-sub.yaml'
result=$(kubectl create -f ds-sub.yaml)
echo $result
sleep 1m
...
echo '*** executing **** kubectl create -f ds-cr.yaml'
result=$(kubectl create -f ds-cr.yaml)
echo $result
