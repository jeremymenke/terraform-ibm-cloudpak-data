...
echo '*** executing **** kubectl create -f wml-sub.yaml'
result=$(kubectl create -f wml-sub.yaml)
echo $result
sleep 1m
...
echo '*** executing **** kubectl create -f wml-cr.yaml'
result=$(kubectl create -f wml-cr.yaml)
echo $result
